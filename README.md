...
`React` `Next.js` `TypeScript` `TailwindCSS` &nbsp;·&nbsp; `Node.js` `Express` `Python` `FastAPI` &nbsp;·&nbsp; `PostgreSQL` `MongoDB` `Supabase` `Prisma` &nbsp;·&nbsp; `OpenAI` `Gemini` `LangChain` `Hugging Face` &nbsp;·&nbsp; `Docker` `Vercel` `Git` `Linux`
...
| ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------- |
| **[NoteRoot](https://github.com/RishiBuilds/NoteRoot)**                                     | Self-hosted markdown knowledge base, compiled to a zero-dependency static Go binary           | Go, Flat-File Architecture            |
| **[MilesToGo-AI](https://github.com/RishiBuilds/MilesToGo-AI)**                             | AI-native travel planner orchestrating multi-day itineraries with 3D geospatial visualization | TypeScript, Next.js, WebGL            |
| **[RepoLens-IQ](https://github.com/RishiBuilds/RepoLens-IQ)**                               | AST-driven repo telemetry mapping codebase topology, dependency graphs, and security vectors  | TypeScript, AST Parsing               |
| **[VyaparKhata](https://github.com/RishiBuilds/VyaparKhata)**                               | GST-compliant billing & ledger platform built for secure, high-volume transactions            | React, Node.js                        |
| **[transforming-optimus-prime](https://github.com/RishiBuilds/transforming-optimus-prime)** | Scroll-driven cinematic experience rendering 200+ frames at 60FPS                             | TypeScript, Canvas API, Framer Motion |
